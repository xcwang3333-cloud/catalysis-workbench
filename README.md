...
The v0.1 common-XY foundation, v0.2 quantitative electrochemistry, v0.3 extended characterization, and v0.4 advanced experimental analysis are released. The reviewed `v0.3.0` tag remains fixed on `845ac4c15d399a8816c7ba66d61ea6ec4cc11293`; the reviewed `v0.4.0` tag is fixed on `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6`.
...
Gate A / Issue #103 / PR #104 completed frozen-scope release hardening on exact head `9d79845d6fae253b01a46794c3c055e4966c6e55`, CI #302 / run `32758548117`, reviews `5010905065` and `5010908809`, and squash merge `ce06abc11559fa7679869fc83a59356735ce6824`, while intentionally retaining version `0.3.0`. Gate B / Issue #105 / PR #106 finalized distribution/runtime version `0.4.0` on final head `ae3dc21b1a3a4e907d8c39eb85d3dbebefd8fbb4`, passed exact-head CI #304 / run `32759679632` and reviews `5011014348`, `5011017132`, and squash-merged as `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6`. Gate C / Issue #107 then created and reverse-verified tag `v0.4.0` on that exact release commit. GitHub Release creation and package publication remain separate actions; package-registry publication has not been performed.
...
- **v0.4:** released as Git tag `v0.4.0` with shared fitting, XPS, EIS, quantitative BET, and product calibration after Gate A/B/C validation; GitHub Release and package publication are separate actions.
