...
- **v0.3:** scientific scope frozen to FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption processing/plotting, and ICP/composition integration; Gate A release hardening is the current stage.
