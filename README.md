...
- Characterization: XRD, Raman, FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption, and the reviewed ICP/composition integration foundation are implemented; the extended characterization additions are released in v0.3. Shared peak-fitting remains deliberately deferred to v0.4 and will be designed together with constrained XPS/spectroscopy consumers; quantitative BET fitting also remains v0.4 scope. XAS remains staged later.
...
The v0.1 scientific/common-XY feature set is released as v0.1.0. The complete v0.2 implementation sequence #19-#28 plus Gate A/B/C release validation is released as `v0.2.0` on 2026-08-24. The tag resolves exactly to reviewed release commit `1f7f4057397c61ef2f771b96fceadc8a529b62d9`.

The complete v0.3 extended-characterization scope is released as `v0.3.0` on 2026-08-24. FTIR/ATR-FTIR was delivered through Issue #50 / PR #51, TGA/DTG/TPR/TPD through Issue #54 / PR #55, basic gas-sorption through Issue #58 / PR #59, and ICP/elemental-composition integration through Issue #62 / PR #63. The scope was then frozen with shared peak-fitting deferred to v0.4/XPS. Gate A / Issue #66 / PR #67 hardened the frozen scope, Gate B / Issue #68 / PR #69 finalized `0.3.0` and passed the fresh exact-wheel audit plus two-pass release review, and Gate C / Issue #70 created and reverse-verified tag `v0.3.0` on release commit `845ac4c15d399a8816c7ba66d61ea6ec4cc11293`. Package-registry publication is not implied by the Git tag and remains out of scope until a separate distribution policy is reviewed.
...
See [`docs/MASTER_PLAN.md`](docs/MASTER_PLAN.md) for the project-wide execution model and current checkpoint, [`docs/V0_2_PLAN.md`](docs/V0_2_PLAN.md) for the completed v0.2 feature/release record, [`docs/V0_2_RELEASING.md`](docs/V0_2_RELEASING.md) for the completed v0.2 release gates, [`docs/V0_3_RELEASING.md`](docs/V0_3_RELEASING.md) for the completed v0.3 Gate A/B/C release record, [`docs/FTIR.md`](docs/FTIR.md) for the reviewed FTIR/ATR-FTIR scientific/API contract, [`docs/THERMAL_ANALYSIS.md`](docs/THERMAL_ANALYSIS.md) for the reviewed TGA/DTG/TPR/TPD scientific/API contract, [`docs/GAS_SORPTION.md`](docs/GAS_SORPTION.md) for the reviewed basic gas-sorption scientific/API contract, [`docs/ICP_COMPOSITION.md`](docs/ICP_COMPOSITION.md) for the reviewed ICP/composition scientific/API contract, and [`docs/ROADMAP.md`](docs/ROADMAP.md) for the long-range release scope.

## Roadmap

- **v0.2:** released as `v0.2.0` on 2026-08-24 after reviewed scientific implementation and Gate A/B/C release validation.
- **v0.3:** released as `v0.3.0` on 2026-08-24 with FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption processing/plotting, and ICP/composition integration after Gate A/B/C validation.
- **v0.4-v0.6:** advanced experimental analysis, beginning with shared constrained peak-fitting designed jointly with XPS, followed by EIS/BET/product calibration, XAS, structures, and major DFT post-processing.
