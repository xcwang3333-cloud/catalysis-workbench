...
The reviewed v0.1 scientific foundation covers common one-dimensional XY workflows: tabular import, reusable processing, LSV/polarization curves, XRD, Raman, and exact-size PNG/SVG/PDF export. The v0.2 quantitative-electrochemistry release is complete: shared electrochemistry quantity/provenance conventions, scatter/bar rendering, Tafel analysis, Faradaic efficiency, product partial-current density, activity normalization, TOF/TOFapp, CV/Cdl/ECSA, stability analysis, and RRDE/Koutecky-Levich basics are released as `v0.2.0`. The v0.3 scientific scope is frozen on top of that stable release: reviewed FTIR / ATR-FTIR, TGA / DTG / TPR / TPD thermal analysis, basic gas-sorption isotherm processing/publication plotting, and ICP/elemental-composition integration are merged. Gate A release hardening is complete through Issue #66 / PR #67. Gate B is now the final-version candidate: distribution/runtime metadata report `0.3.0` on the release branch and must pass a fresh exact-wheel audit before merge. No `v0.3.0` tag or package publication is implied by Gate B.
...
- Characterization: XRD, Raman, FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption, and the reviewed ICP/composition integration foundation are implemented and form the frozen v0.3 characterization scope. Shared peak-fitting is deliberately deferred to v0.4 and will be designed together with constrained XPS/spectroscopy consumers; quantitative BET fitting also remains v0.4 scope. XAS remains staged later.
...
Post-release v0.3 development added FTIR/ATR-FTIR through Issue #50 / PR #51, TGA/DTG/TPR/TPD through Issue #54 / PR #55, the basic gas-sorption foundation through Issue #58 / PR #59, and ICP/elemental-composition integration through Issue #62 / PR #63. After the post-ICP checkpoint, the v0.3 scope was explicitly frozen: shared peak-fitting is deferred to v0.4/XPS. Gate A was completed through Issue #66 / PR #67 at version `0.2.0`. Gate B / Issue #68 now stages the synchronized `0.3.0` distribution/runtime candidate and requires a fresh exact-wheel audit plus two-pass release/API/packaging/compatibility review before merge. Gate B still does not create the `v0.3.0` tag; that remains Gate C.
...
See [`docs/MASTER_PLAN.md`](docs/MASTER_PLAN.md) for the project-wide execution model and current checkpoint, [`docs/V0_2_PLAN.md`](docs/V0_2_PLAN.md) for the completed v0.2 feature/release record, [`docs/V0_2_RELEASING.md`](docs/V0_2_RELEASING.md) for the completed v0.2 release gates, [`docs/V0_3_RELEASING.md`](docs/V0_3_RELEASING.md) for the frozen v0.3 scope and Gate A/B/C procedure, [`docs/FTIR.md`](docs/FTIR.md) for the reviewed FTIR/ATR-FTIR scientific/API contract, [`docs/THERMAL_ANALYSIS.md`](docs/THERMAL_ANALYSIS.md) for the reviewed TGA/DTG/TPR/TPD scientific/API contract, [`docs/GAS_SORPTION.md`](docs/GAS_SORPTION.md) for the reviewed basic gas-sorption scientific/API contract, [`docs/ICP_COMPOSITION.md`](docs/ICP_COMPOSITION.md) for the reviewed ICP/composition scientific/API contract, and [`docs/ROADMAP.md`](docs/ROADMAP.md) for the long-range release scope.

## Roadmap

- **v0.2:** released as `v0.2.0` on 2026-08-24 after reviewed scientific implementation and Gate A/B/C release validation.
- **v0.3:** scientific scope frozen to FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption processing/plotting, and ICP/composition integration; Gate A is complete and Gate B / Issue #68 is the active `0.3.0` final-version candidate. Gate C remains separately authorization-gated.
- **v0.4-v0.6:** advanced experimental analysis, including shared constrained peak-fitting designed with XPS, followed by XAS, structures, and major DFT post-processing.
