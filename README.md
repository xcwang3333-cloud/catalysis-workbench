...
v0.5 scientific implementation is complete. The architecture checkpoint is #115/#116; XAS/XANES #117/#118; FT-EXAFS #119/#120; WT-EXAFS #121/#122; EXAFS fitting summaries #123/#124; atomic structures/adapters #125/#126; geometry/coordination/comparison #127/#129; static structure visualization #130/#131; and basic DFT energetics #132/#133. The scientific-completion commit is `a7ebd009ec83b0aeb068ad2d2f6712c17a783f1f`. Issue #134 synchronizes completion-state documentation, after which Gate A frozen-scope release hardening is next.
...
See [`docs/MASTER_PLAN.md`](docs/MASTER_PLAN.md) for the project-wide execution model and current checkpoint, [`docs/V0_5_PLAN.md`](docs/V0_5_PLAN.md) for the v0.5 architecture/completion state, [`docs/V0_4_RELEASING.md`](docs/V0_4_RELEASING.md) for the v0.4 release-gate record, and [`docs/ROADMAP.md`](docs/ROADMAP.md) for the long-range release scope. Technique-specific reviewed contracts are linked from the capability sections above.
...
- **v0.5:** frozen scientific scope complete; XAS/EXAFS, structures/geometry/static structure visualization, and basic DFT energetics are merged; completion docs sync then Gate A is next.
