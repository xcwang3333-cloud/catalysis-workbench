...
- `catalysis_workbench.experimental.characterization`: XRD, Raman, FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption, ICP/elemental-composition, XPS preparation, and constrained XPS fitting; XPS public state includes validation, explicit additive binding-energy correction, measured-point region preparation, immutable linear/Shirley background results, `XPSDoubletSpec`, `XPSPeakFitResult`, and `fit_xps_peaks`; XPS publication plotting is the next stage and is not yet implemented.
...
- Characterization: XRD, Raman, FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption, and ICP/composition are implemented and released in v0.3. The shared constrained peak-fitting foundation, XPS semantics/energy-correction/region/background-preparation layer, and constrained XPS fitting integration are now implemented on `main` as the first three v0.4 scientific blocks. XPS publication plotting/diagnostics is next; EIS, quantitative BET, and product calibration remain subsequent v0.4 work. XAS remains staged later.
...
v0.4 architecture was defined through Issue #73 / PR #74. Shared constrained peak fitting completed Issue #75 / PR #76 with exact-head CI #255, two formal reviews, and squash merge commit `b6f428d96df9950373c17e5de487ac4113a2aacc`. XPS preparation completed Issue #79 / PR #80 with exact-head CI #261, formal reviews `5008700786` and `5008706395`, and squash merge commit `a13dbd541b299f79d83e47f079c4638b082a8061`. Constrained XPS fitting completed Issue #83 / PR #84 with final exact-head CI #267 / run `32739584536`, formal reviews `5009021201` and `5009026855`, and squash merge commit `7897393e1e1e9e4d23fad774b4eeecdd70e2a90b`. Runtime/distribution version remains `0.3.0`; these development checkpoints do not authorize a v0.4 release/tag/package publication.
...
See [`docs/MASTER_PLAN.md`](docs/MASTER_PLAN.md) for the project-wide execution model and current checkpoint, [`docs/V0_4_PLAN.md`](docs/V0_4_PLAN.md) for the active v0.4 dependency order, [`docs/PEAK_FITTING.md`](docs/PEAK_FITTING.md) for the shared fitting contract, [`docs/XPS.md`](docs/XPS.md) for the XPS preparation/constrained-fitting contract, [`docs/V0_3_RELEASING.md`](docs/V0_3_RELEASING.md) for the completed v0.3 release record, and [`docs/ROADMAP.md`](docs/ROADMAP.md) for the long-range release scope.
...
- **v0.4:** implementation active — shared constrained fitting, XPS preparation, and constrained XPS fitting complete; XPS publication plotting/diagnostics is next, followed by EIS, quantitative BET, and product calibration.
