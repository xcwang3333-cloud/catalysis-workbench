...
- **v0.3:** scientific scope frozen to FTIR/ATR-FTIR, TGA/DTG/TPR/TPD, basic gas-sorption processing/plotting, and ICP/composition integration; Gate A is audited through Issue #66 / PR #67 before the separate Gate-B final-version candidate.
