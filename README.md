...
The frozen v0.5 scientific scope is complete on `main` at `a7ebd009ec83b0aeb068ad2d2f6712c17a783f1f`. Reviewed v0.5 capabilities include explicit XAS/XANES preparation and normalization; FT-EXAFS and WT-EXAFS transforms/visualization; neutral EXAFS fitting-result summaries; immutable atomic structures with optional POSCAR/CONTCAR/CIF/XYZ adapters; explicit periodic-image geometry, coordination and caller-mapped structure comparison; renderer-neutral static structure visualization; and explicit total/relative/reaction/adsorption-energy post-processing. Gate A release hardening completed through #136/#137 at `0ffcd7e4a89340d993468039ba83b44bc7638050`; Gate B finalized and exact-wheel validated distribution/runtime version `0.5.0` through #138/#139 at `9400ac0044ac333d2cae228554c08d955a816a4c`. No `v0.5.0` tag exists yet: Gate C remains a separate explicit authorization boundary. PyPI/package-registry publication remains deferred.
...
The tagged v0.1.0 release used a separate release-hardening gate followed by a final-version gate; see [`docs/RELEASING.md`](docs/RELEASING.md). v0.2 followed the dedicated Gate A/B/C procedure in [`docs/V0_2_RELEASING.md`](docs/V0_2_RELEASING.md), v0.3 followed the same separation in [`docs/V0_3_RELEASING.md`](docs/V0_3_RELEASING.md), and v0.4 uses [`docs/V0_4_RELEASING.md`](docs/V0_4_RELEASING.md). The reviewed `v0.3.0` tag remains fixed on release commit `845ac4c15d399a8816c7ba66d61ea6ec4cc11293`; the reviewed `v0.4.0` tag remains fixed on `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6`. v0.5 architecture/completion state is maintained in [`docs/V0_5_PLAN.md`](docs/V0_5_PLAN.md), with Gate A/B/C evidence in [`docs/V0_5_RELEASING.md`](docs/V0_5_RELEASING.md). Gate A and Gate B are complete; distribution/runtime version is `0.5.0`. Gate C tag creation is not yet authorized, and no `v0.5.0` tag exists. A Git tag or GitHub Release does not itself publish a package-registry artifact, and PyPI publication is currently deferred.
...
The v0.1 common-XY foundation, v0.2 quantitative electrochemistry, v0.3 extended characterization, and v0.4 advanced experimental analysis are released. The reviewed `v0.3.0` tag remains fixed on `845ac4c15d399a8816c7ba66d61ea6ec4cc11293`; the reviewed `v0.4.0` tag is fixed on `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6`, and its GitHub Release is published. PyPI/package-registry publication is deferred.

v0.5 scientific implementation, Gate A, and Gate B are complete. The architecture checkpoint is #115/#116; XAS/XANES #117/#118; FT-EXAFS #119/#120; WT-EXAFS #121/#122; EXAFS fitting summaries #123/#124; atomic structures/adapters #125/#126; geometry/coordination/comparison #127/#129; static structure visualization #130/#131; and basic DFT energetics #132/#133. The scientific-completion commit is `a7ebd009ec83b0aeb068ad2d2f6712c17a783f1f`. Gate A completed at `0ffcd7e4a89340d993468039ba83b44bc7638050`; Gate B exact-wheel validation finalized distribution/runtime version `0.5.0` at `9400ac0044ac333d2cae228554c08d955a816a4c`. No `v0.5.0` tag exists yet, so the next release boundary is Gate C and requires separate explicit authorization.
...
See [`docs/MASTER_PLAN.md`](docs/MASTER_PLAN.md) for the project-wide execution model and current checkpoint, [`docs/V0_5_PLAN.md`](docs/V0_5_PLAN.md) for the v0.5 architecture/completion state, [`docs/V0_5_RELEASING.md`](docs/V0_5_RELEASING.md) for v0.5 Gate A/B/C evidence, [`docs/V0_4_RELEASING.md`](docs/V0_4_RELEASING.md) for the v0.4 release-gate record, and [`docs/ROADMAP.md`](docs/ROADMAP.md) for the long-range release scope. Technique-specific reviewed contracts are linked from the capability sections above.
...
- **v0.5:** scientific scope plus Gate A/B are complete; distribution/runtime version is `0.5.0`; Gate C tag creation/reverse verification is pending separate authorization.
