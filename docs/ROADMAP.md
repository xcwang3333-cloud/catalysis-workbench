...
CatalysisWorkbench is developed through staged scientific/version milestones, while stable GitHub Releases are reserved for infrequent maturity checkpoints. The project focuses on quantitative post-processing, comparative analysis, and publication-quality visualization of catalysis data.

**Release retention policy (2026-08-27):** `v0.7.0` is the only currently retained stable GitHub Release/tag. The v0.1-v0.6 sections below remain historical development/release records, but their old GitHub Release/tag artifacts were intentionally removed during repository cleanup; that cleanup does not erase their implementation, Issue/PR, commit, CI, or Gate evidence. The completed v0.8 scientific implementation milestone will not receive a standalone `v0.8.0` tag or GitHub Release. Continuing development proceeds on the `0.9.0.dev0` line, which is development state rather than a stable Release. Future GitHub Releases are intentionally low-frequency maturity checkpoints, and PyPI/package-registry publication remains a separate deferred decision.
...
The architecture-first dependency order is maintained in [`V0_4_PLAN.md`](V0_4_PLAN.md), with historical release evidence in [`V0_4_RELEASING.md`](V0_4_RELEASING.md). All scientific scope, Gate A release hardening, Gate B final-version validation, Gate C tag verification, post-tag documentation synchronization, and GitHub Release publication were completed at that milestone. Historically, `v0.4.0` was reverse-verified on release commit `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6` with distribution/runtime version `0.4.0`; its old tag/GitHub Release artifact is no longer retained. Package-registry/PyPI publication remains deferred.
...
Gate B / Issue #105 / PR #106 finalized distribution/runtime version `0.4.0`; final head `ae3dc21b1a3a4e907d8c39eb85d3dbebefd8fbb4` passed CI #304 / run `32759679632` and reviews `5011014348`, `5011017132` before squash merge `bb4cb26a500eb1a1a1ce98fdf42760d33e7d7cd6`. Gate C / Issue #107 then created and reverse-verified `v0.4.0` on that exact commit, and the GitHub Release was subsequently published from that tag at the time. The old tag/Release artifact is no longer retained; package publication remains deferred.

## v0.5.0 — XAS, structures, and basic DFT energetics — released 2026-08-25

The reviewed dependency order and scientific contracts are maintained in [`V0_5_PLAN.md`](V0_5_PLAN.md), with historical release evidence in [`V0_5_RELEASING.md`](V0_5_RELEASING.md). All eight scientific blocks, completion-state synchronization, Gate A frozen-scope hardening, Gate B final-version exact-wheel validation, Gate C tag verification, GitHub Release publication, and final post-release documentation synchronization were completed at that milestone. Historically, distribution/runtime version was finalized to `0.5.0`, tag `v0.5.0` was reverse-verified on reviewed release commit `9400ac0044ac333d2cae228554c08d955a816a4c`, and the GitHub Release was published from that tag. The old tag/Release artifact is no longer retained. PyPI/package publication remains deferred.
...
- GitHub Release / #144: `CatalysisWorkbench v0.5.0` was publicly published from the verified tag with populated release notes at that historical milestone; the old artifact is no longer retained.
...
The architecture-first v0.6 scope, scientific semantics, dependency boundaries, prior-art/license decisions, test strategy, and implementation order are frozen in [`V0_6_PLAN.md`](V0_6_PLAN.md), with historical release evidence in [`V0_6_RELEASING.md`](V0_6_RELEASING.md). All nine scientific blocks, completion-state synchronization, Gate A frozen-scope hardening, Gate B exact-wheel final-version validation, Gate C tag verification, and GitHub Release publication were completed at that milestone. Historically, `v0.6.0` was reverse-verified on reviewed release commit `c7793b309f41d174c14534bd6d4acdacc2a57636`, distribution/runtime version through the tag was `0.6.0`, and the GitHub Release was published. The old tag/Release artifact is no longer retained. PyPI/package publication remains deferred.
...
- GitHub Release / #193: `CatalysisWorkbench v0.6.0` was publicly published from the verified tag with reviewed release notes at that historical milestone; the old artifact is no longer retained.
...
All seven v0.7 implementation blocks, scientific-completion synchronization, Gate A/B/C, tag verification, GitHub Release publication, and publication-evidence synchronization are complete. Post-release Issue #245 / PR #246 added the backwards-compatible `symmetric_color_limits()` maintenance primitive as v0.8 heatmap groundwork later consumed by Block 3 without changing version, tag, release, or package-registry state. The retained stable GitHub Release/tag is `v0.7.0`, fixed on `e3062fc12c794f54c7b7613875ec73608a587a59`; distribution/runtime release version is `0.7.0`; PyPI remains deferred.

VASP/HPC job submission and complete workflow management remain outside the current project scope.

## v0.8.x — Operando and time-resolved data — scientific implementation milestone complete; no standalone GitHub Release/tag

The six-block architecture is frozen in [`V0_8_PLAN.md`](V0_8_PLAN.md) through Issue #249 / PR #250 at `fa7baaf8ce68369b0e732faf4e7621a818db92b6`; post-merge CI #550 / run `32920821932` passed. Block 1 is complete through Issue #253 / PR #254 at expected-head squash merge `45d0515dd5c1c70f15f4d5cd76ba2a359dc66bb2`; final head `eadf5b2e6630b137922f365a88f4b9ef3c43b12b` passed CI #561 / run `32922150384` and formal reviews `5026150379`, `5026170031`, and post-merge main CI #562 / run `32922349620` passed on the merge commit. Block 2 is complete through Issue #257 / PR #258 at expected-head squash merge `86cd463e288eca08c7917945fafbf630493ede92`; final exact head `9fc8e372f15015de1d65705cedd0ad68414613b7` passed CI #580 / run `32925586441`, the review-1 fail-closed result-state blocker was fixed and regression-tested, formal review 2 `5026418909` found no blockers with zero unresolved threads, and post-merge main CI #581 / run `32925811342` passed. Block 3 is complete through Issue #263 / PR #264 at expected-head squash merge `4a5b5ee0f75321dbf3a679ab616ac69972e34575`; final exact head `37c69c18e3e81bd228eadf3c4c2e3b5b8540a8a1` passed CI #594 / run `32927718634`, formal reviews `5026595721`, `5026596493` found no blockers with zero unresolved threads, and post-merge main CI #595 / run `32928011235` passed. Block 4 is complete through Issue #267 / PR #268 at expected-head squash merge `d46b57c5c558a06880e58d1b0bb15b6fd1c96a8c`; final exact head `45314c9c16c5460c8a9d574ec3fb43c6dfef722f` passed CI #612 / run `32930071404`, formal reviews `5026779773`, `5026780870` found no blockers with zero unresolved threads, and post-merge main CI #613 / run `32930335459` passed. Block 5 is complete through Issue #271 / PR #272 at expected-head squash merge `b3aa8f59834f4c3fe5e4bffe94111b60ca360570`; final exact head `a7fc080cd564191205dd8d8f8882b6e60e891ce5` passed CI #637 / run `32931971740`, formal reviews `5026944037`, `5026945010` found no blockers with zero unresolved threads, and post-merge main CI #638 / run `32932720710` passed. Block 6 is complete through Issue #275 / PR #276 at expected-head squash merge `b5503ea7b48ca421d5ddf49e35b74f8f4e24791f`; final exact head `6ddd7331363293593741dccb8b74ec9ed0dea3e2` passed CI #650 / run `32933715614`, formal reviews `5027028638`, `5027030329` found no blockers with zero unresolved threads, and post-merge main CI #651 / run `32933955320` passed.
...
4. **Operando Raman and FTIR adapters with caller-specified band/peak trajectories — complete through #267 / #268.**
   - exact-grid Raman/FTIR adapters reuse reviewed domain validators and preserve literal source arrays/digests while allowing only semantic alias/unit canonicalization; direct band-area and observed peak-position trajectories require caller-supplied windows, and fit-derived center/FWHM trajectories consume caller-supplied compatible `PeakFitResult` state with explicit model/source/window/axis/unit provenance; Gaussian, Lorentzian, pseudo-Voigt, and Voigt widths follow retained lmfit model conventions, while unsupported Doniach width extraction fails closed; no automatic peak detection/fitting, baseline correction, smoothing, normalization, transmittance conversion, or species assignment is introduced.
5. **Operando XAS/XANES adapters, mapping, and explicit descriptor trajectories — complete through #271 / #272.**
   - reviewed raw-XAS and normalized-XANES adapters remain explicitly separated and fail closed on incompatible grid/reference/normalization state; white-line intensity uses an observed retained-point maximum, edge position uses the maximum adjacent measured-point secant under an explicit caller window, and window integration uses retained measured points with the numerical rule recorded; all trajectories reuse immutable `OperandoTrace` provenance and existing passive renderers; no hidden energy alignment, interpolation, resampling, smoothing, automatic fitting, species fraction, oxidation-state, LCF, or chemical assignment is introduced.
6. **Operando XRD adapters, mapping, and caller-window/peak trajectories — complete through #275 / #276.**
   - exact-grid XRD adapters preserve released strictly increasing 2theta semantics, literal source arrays/order, and compatible intensity/normalization basis; caller-window integration uses only retained measured points, observed peak position requires one unique retained maximum, and caller-supplied compatible `PeakFitResult` center/FWHM consumers reuse reviewed lmfit model conventions; heatmap/trace mapping reuses passive Block-3 renderers; no hidden normalization, interpolation/resampling, automatic peak fitting/discovery, phase identification/indexing/database matching, lattice/refinement/phase-fraction inference, or new dependency is introduced.

The frozen contract requires literal common grids, explicit coordinates/units/provenance, retained acquisition order, passive renderers, and fail-closed incompatibility. It performs no hidden alignment, interpolation, smoothing, baseline correction, normalization, chemical assignment, XAS species inference, XRD phase inference, or causal interpretation. All six scientific implementation blocks are complete. The standalone v0.8 Release cycle is retired: no v0.8 release Gate path, `v0.8.0` tag, or GitHub Release is planned. These capabilities carry forward into ongoing development on the `0.9.0.dev0` line, while current `main` remains at distribution/runtime version `0.7.0` until future development integration.

## v0.9.x — Reproducible and interactive workflows — ongoing/next `0.9.0.dev0` development line

The `0.9.0.dev0` development line is the continuation point after the completed v0.8 scientific implementation milestone. It defines ongoing development scope rather than a stable GitHub Release, and the items below must not be interpreted as already merged simply because they are listed here.
