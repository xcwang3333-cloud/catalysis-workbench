"""Internal rendering helpers shared by non-curve visualization primitives."""
...
def figure_axes_context(spec: FigureSpec) -> Iterator[tuple[Figure, Axes]]:
    """Create a headless figure/axes pair under an isolated Matplotlib rc context."""
    layout = spec.layout
    style = spec.style
    rc = {
...
def finish_axes(
    ...
    *,
    ...
    """Apply shared scale, typography, tick, legend, and annotation semantics."""
    style = spec.style
